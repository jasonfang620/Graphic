...
void Mesh::GenerateNormals() {
	...
	m->colours[3] = Vector4(1.0f, 0.0f, 0.0f, 0.5f);
	m->colours[4] = Vector4(0.0f, 1.0f, 0.0f, 0.5f);
	m->colours[5] = Vector4(0.0f, 0.0f, 1.0f, 0.5f);
	m->BufferData();
...
void Mesh::Draw() {
	...
	glBindVertexArray(arrayObject);
	//glActiveTexture(GL_TEXTURE0);	//which texture unit to store it to

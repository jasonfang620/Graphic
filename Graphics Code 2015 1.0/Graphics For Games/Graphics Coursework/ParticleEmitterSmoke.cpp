...
ParticleEmittersmoke::ParticleEmittersmoke()
{
	texture = SOIL_load_OGL_texture(TEXTUREDIR"rain.png",
...
void ParticleEmittersmoke::Update(float msec)
{
...
Particle* ParticleEmittersmoke::GetFreeParticle()
{
	Particle * p = NULL;

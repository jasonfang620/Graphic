...
Particlefog::Particlefog(string name) {
	particleRate = 100.0f;
	particleLifetime = 500.0f;
	particleSize = 24.0f;
	particleVariance = 0.2f;
	...
	*/
	...
	texture = SOIL_load_OGL_texture(name.c_str(),
		SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_COMPRESS_TO_DXT);
...
*/
void Particlefog::Update(float msec) {
...
*/
Particle* Particlefog::GetFreeParticle() {
	Particle * p = NULL;
